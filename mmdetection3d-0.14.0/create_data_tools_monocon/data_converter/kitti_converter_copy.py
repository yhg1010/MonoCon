...
from tools.data_converter.kitti_data_utils import get_kitti_image_info, get_waymo_image_info
...
def create_kitti_info_file(data_path,
    ...
    train_img_ids = _read_imageset_file(str(imageset_folder / 'manual_train.txt'))
    val_img_ids = _read_imageset_file(str(imageset_folder / 'short_distance_manual_front_val.txt'))
